...
* **tflint:** 🐛 bump Azure rules version, fix signature bug 7840ae7

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.12.1 9b39ed0
* **deps:** update dependency opentofu to v1.12.2 7f984d2
* **deps:** update dependency opentofu to v1.12.3 6584184
* **deps:** update dependency opentofu to v1.12.4 0bfa65d
* **deps:** update dependency tflint to v0.63.1 725613a
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.1 3368f25
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.2 eb88c5a

## 8.2.4 (2026-06-02)

### Bug Fixes

* 🐛 default output `resource` now require sensitive with OpenTofu 1.12+ 47fbc22

### Miscellaneous Chores

* **deps:** 🔗 update mise conf for OpenTofu a154001
* **deps:** update dependency opentofu to v1.11.7 512e25f
* **deps:** update dependency opentofu to v1.12.0 bfb20c4
* **deps:** update dependency terraform-docs to v0.23.0 4a5ccbf
* **deps:** update dependency terraform-docs to v0.24.0 a270e36
* **deps:** update dependency tflint to v0.62.1 a3fc153
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.3.0 bb51b0b
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.0 735c9ee
* **deps:** update tools d8587b1
* **pre-commit:** 🔧 move to prek d82db34
* **tfdocs:** bump tfdocs to v0.22 🔧 8026f37

## 8.2.3 (2026-03-27)

### Bug Fixes

* **trivy:** 🐛 drop unsafe trivy pre-commit 🔒️ 30d063c

### Code Refactoring

* update module structure and Github actions 👷 02b96e8

### Miscellaneous Chores

* **AI:** 🤖 add AI Agents instructions for Contributing 444fe95
* **deps:** 🔗 bump tflint rules version 03229fb
* **deps:** update dependency trivy to v0.69.2 d39fe72
* **deps:** update dependency trivy to v0.69.3 82c09fb
* **deps:** update pre-commit hook crate-ci/committed to v1.1.11 6463444

## 8.2.2 (2026-02-13)

### Code Refactoring

* **gitlab MR template:** ♻️ update default reviewers group with Azure Factory 🔧 c4716d9

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.10.7 f9c4e81
* **deps:** update dependency opentofu to v1.11.2 f0711e9
* **deps:** update dependency opentofu to v1.11.3 ac73a3c
* **deps:** update dependency opentofu to v1.11.4 613674f
* **deps:** update dependency opentofu to v1.11.5 c8ba2ff
* **deps:** update dependency pre-commit to v4.4.0 c0749a1
* **deps:** update dependency pre-commit to v4.5.0 b536135
* **deps:** update dependency pre-commit to v4.5.1 31ae6b3
* **deps:** update dependency tflint to v0.60.0 afd207a
* **deps:** update dependency tflint to v0.61.0 24aa83c
* **deps:** update dependency trivy to v0.67.0 275747a
* **deps:** update dependency trivy to v0.67.1 0b901c5
* **deps:** update dependency trivy to v0.67.2 257af17
* **deps:** update dependency trivy to v0.68.1 52e76ab
* **deps:** update dependency trivy to v0.68.2 903946c
* **deps:** update dependency trivy to v0.69.0 7355875
* **deps:** update dependency trivy to v0.69.1 92eb1b8
* **deps:** update pre-commit hook crate-ci/committed to v1.1.10 ae32022
* **deps:** update pre-commit hook crate-ci/committed to v1.1.8 8e27f66
* **deps:** update pre-commit hook crate-ci/committed to v1.1.9 8b6a1a7
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.2.2 0eee0d0
* **deps:** update tools bea0b89
